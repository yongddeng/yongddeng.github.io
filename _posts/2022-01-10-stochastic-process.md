...
Note that $(I\_{t})_{t\in\mathbb{N}}$ consists of $I\_{t} = (X\_{t} + 1)/2$ is a Bernoulli trials sequence with success parameter $p$, and thus $R\_{n} = \Sigma\_{t=1}^{n} I\_{t}$ follows the binomial dist. with trial parameter $n$ and success parameter $p$. 

...
# Mode of Convergence
---
One of the basis of probability theory is the stabilisation of the [relative frequencies](https://www.mathsisfun.com/data/relative-frequency.html). That is, we want to systematically predict an event that may or may not be unchanging as it goes far enough into the sequence.

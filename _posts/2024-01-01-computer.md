...
Processors being more dedicated to a specific task, such as machine learning (ML), can offload CPU in many ways. Currently the most famous ML processor is GPU... We have AWS's Inferentia (inf1), Google's TPU, Apple's ANE, and etc... For example, inf1 is based on the [Application Specific Integrated Circuits]() (ASIC), offering ...

<img src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ePAKUjsHi4aAHeLSpUuXcg.png" width="500" alt="https://towardsdatascience.com/ai-accelerators-machine-learning-algorithms-and-their-co-design-and-evolution-2676efd47179">
<!-- 
...
CUDA is a programming framework and platform, with dedicated NVCC (i.e. LLVM-based custom compiler) for translating CUDA code into executable GPU programs. CUDA provides a set of APIs, libraries, and tools for developers to write programs executable on NVIDIA GPUs. NVCC lowers high-level CUDA code (e.g. C, C++, or Fortran) into i) parallel thread execution (PTX): An interim representation; and ii) machine code (CUBIN): GPU-specific binary code; The compiler passes CPU-specific portions of the CUDA code to a standard compiler like GCC or Clang, while GPU-specific portions (marked by *device* or *global* keywords) are passed into PTX or machine code;

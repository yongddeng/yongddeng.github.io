...
An optimal compilation can accelerate model execution with CUDA/HIP graph...  Many deep learning compilers, such as [NVIDIA's CUDA Compiler]() (NVCC), use LLVM as its core. Many DL compilers tend to be graph-based... There are many alternatives such as... Triton is... Therefore, one use other backend besides LLVM compiler (i.e. LLC) for purposes.

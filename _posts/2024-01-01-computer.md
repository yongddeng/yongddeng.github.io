...
High-level [programming languages]() abstract away the complexities of direct binary manipulation (i.e. shown in the image). They allow developers to write code in a human-readable format, relying on compilers/interpreters to translate this code into machine language. This abstraction is crucial for productivity, enabling the creation of complex systems without requiring an in-depth understanding of hardware-specific details like binary encoding or CPU instruction sets. Languages like Python, Java, and C++ provide tools and libraries that simplify interaction with I/O devices, allowing developers to focus on functionality rather than low-level operations. 
...
Most ML practitioners prefer ... Having understood the compilation workflows would benefit ... PyTorch is preferred by researchers as its UX can keep the nature of doing Python programming... PyTorch (and other frameworks, not only limited to ML) attempted to ... as writing compilers are unpleasant... Perhaps, 

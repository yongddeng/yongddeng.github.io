...
\_\_torch_dispatch\_\_ is .... This is a diagram of how torch_dispatch might work with vmap, where the dotted arrows represent paths that could have been take. \_\_torch_dispatch\_\_ is the only way to go from C++ back into Python....  <!-- Note that AOTAutograd compiles computations (prior to execution) within the dynamic context of TorchDynam, so the term ahead-of-time is relative to the specific computation being intercepted and optimized at runtime -->

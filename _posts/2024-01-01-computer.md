...
### **3.3. Interpreter w/wo JIT**
<p style="margin-bottom: 12px;"> </p>

Historically, interpreters represented source code as ASTs and executed line-by-line using an [recursion](). These [trees](), while well-suited for program structure representation, were not optimised for execution. That is, types of optimisation were limited, and lowering source code to machine code was also challenging. Interpreters gained widespread adoption among a group of people who prefer the iterative and experimental workflows. In the meantime, compilers remain difficult to be newly developed, despite tons of research and know-how, and modern interpreter rather compile source code into [bytecode]() and employe a [virtual machine]() (i.e. VM) for executions.

<!-- - <div style="position: relative; display: inline-block;"> <img src="https://blogs.brain-mentors.com/content/images/size/w1600/2023/11/The-PVM-employs-a-JIT-compiler-known-as--Pyston--to-generate-machine-code-from-bytecode--improving-Python-s-execution-speed.-JIT-Compilation-in-Python-aims-to-mitigate-the--Global-Interpreter-Lock--1--1.png" width="500"> <a href="https://blogs.brain-mentors.com/lets-discuss-how-python-work-internally/" target="_blank" style="position: absolute; top: 0px; right: 4px; font-size: 12px;">[src]</a> </div> -->

For instance, [CPython]() (i.e. Python) compiler transforms source code (i.e. .py) into a platform-independent bytecode (i.e. .pyc). [Python VM]() (PVM), the stack-based interpreter, then sequentially (i.e. line-by-line) execute bytecode during runtime by interacting with the OS and underlying hardware. [PEP 3147](https://peps.python.org/pep-3147/) introduced .pyc repository directories, called [\_\_pycache\_\_](), to better group clutter and enhance cross-version compatibility. The *dis* module can inspect bytecode, revealing the IR generated from source code (i.e. string or script).... 

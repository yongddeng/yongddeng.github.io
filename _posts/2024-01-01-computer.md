...
Processors being more dedicated to a specific task, such as machine learning (ML), can offload CPU in many ways. Currently the most famous ML processor is GPU... We have AWS's Inferentia (inf1), Google's TPU, Apple's ANE, and etc... For example, inf1 is based on the [Application Specific Integrated Circuit]() (ASIC) in which ASIC is not normally programmable and does not expose developer focused APIs.

...
- "> <img src="https://blog.paperspace.com/content/images/size/w1600/2022/06/a100.png" width="500" alt="A100 GPU"> <a href="https://www.backblaze.com/blog/ssd-vs-hdd-future-of-storage/" target="_blank" style="position: absolute; bottom: -8px; right: 4px; font-size: 12px;">[src]</a> </div>
 
Ssimilar hardware specifications can exhibit huge differences in performance. For instance, the use of smaller [transistors]() may reduce power consumption, require lower voltage thresholds, generate less heat, and so ultimately allow for a higher density of transistors to be integrated into the design and enhancing overall performance. That is, architectural innovations are indeed important, even though data access patterns is the most influential factor for the maximum GPU utilisation. A simplified JSON representation of the [Ampere architecture](https://www.nvidia.com/en-us/technologies/) (A100 40GB) highlights key components that can also be found in there latestest models.

- A100 of the GA100 has 7 GPCs, 7-8 TPCs/GPC, 2 SMs/TPC, up to 16 SMs/GPC, 108 SMs.
...
- <div style="position: relative; display: inline-block;"> <img src="https://global.discourse-cdn.com/flex036/uploads/pytorch1/optimized/1X/0acfd47dba84bd41567e518cdb6b51e5c5001444_2_870x1000.jpeg" width="500" height="550"> <a href="https://dev-discuss.pytorch.org/t/torchdynamo-update-6-training-support-with-aotautograd/570" target="_blank" style="position: absolute; top: 0px; left: 4px; font-size: 12px;">[src]</a> </div>
...
- <div style="position: relative; display: inline-block;"> <img src="../assets/blog/2024-01-01-torchinductor.png" width="500" height="260"> <a href="https://hc2023.hotchips.org/assets/program/tutorials/ml/PyTorch%202.0.pdf" target="_blank" style="position: absolute; bottom: -8px; right: 4px; font-size: 12px;">[src]</a> </div>
- <div style="position: relative; display: inline-block;"> <img src="https://pytorch.org/assets/images/training-production-ai-models/blog-fig1.jpg" width="500" height="138"> <a href="https://pytorch.org/blog/training-production-ai-models/?utm_source=social-facebook&utm_medium=m4d&utm_campaign=organic&utm_content=post-url&utm_offering=artificial-intelligence&utm_product=training-production-ai-models_01302024&eventSource=organicsocialm4d&content_id=FmvhyYO3MCBLU8r" target="_blank" style="position: absolute; bottom: -10px; right: 4px; font-size: 12px;">[src]</a> </div>

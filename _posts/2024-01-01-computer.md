...
Cross-compiling has become more accessible with LLVM, but despite extensive research and expertise, developing compilers remains challenging and limits their widespread use. Accordingly, interpreters have gained popularity among users who favour iterative as well as experimental workflows. Modern interpreters convert source code into [bytecode](), which is i) hardware-agnostic: independent of the CPU's [instruction set architecture]() (ISA); and ii) executable on any platform with a compatible [virtual machine]() (VM) (e.g. Linux, macOS, Window). Compilation is often faster than -to binary, and their sequential instruction execution (i.e. line-by-line) makes them dynamic.

...
Bytecode, formed by combining opcodes and operands, serves as an IR which the CPython interpreter can efficiently execute. In fact, CPython continues to improve its efficiency via various optimisations. Regarding opcodes, the [adaptive interpreter](), introduced in [PEP 659](https://docs.python.org/3/whatsnew/3.11.html#whatsnew311-pep659), dynamically replaces generic opcodes with specialised, faster versions at runtime based on profiling data. It reduces overhead for frequently executed instructions, and so significantly enhances execution speed. One can indeed disassemble Python opcodes using the *dis* module or examine further from the CPython source code: [[Include/opcode.h](https://github.com/python/cpython/blob/main/Include/opcode.h), [Python/opcode_targets.h](https://github.com/python/cpython/blob/main/Python/opcode_targets.h), [Lib/opcode.py](https://github.com/python/cpython/blob/main/Lib/opcode.py)]. 

...
Whereas, programmers directly interact with computers by coding. At the lowest level, computing begins with machine code consists of [binary]() instructions that are the CPU interpretable and/or executable. [Assemblies]() (e.g. x86, ARM, MIPS) layered human-readable mnemonics that can be converted into machine code. Low-level languages such as C, that use [compilers](https://www.reddit.com/r/ProgrammingLanguages/comments/1475h9o/how_to_make_a_compiler/) to convert [source code]() into an [executable](), offer higher abstraction while maintaining hardware control. The evolution continued with high-level languages such as Python, Java, and C++. They abstract away hardware complexities and use compilers or [interpreters]() (i.e. may or may not employ JIT).

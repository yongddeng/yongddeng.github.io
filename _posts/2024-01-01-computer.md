...
Processors being more dedicated to a specific task, such as machine learning (ML), can offload CPU in various ways. Currently the most famous ML processor is GPU... For instance, AWS's Inferentia may be appealing for its cost efficiency.

<img src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ePAKUjsHi4aAHeLSpUuXcg.png" width="500">
<!-- 

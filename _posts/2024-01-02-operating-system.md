...
# Operating System
---
An operating system, often taken for granted, is less than a century old yet underpins nearly all computing devices today. Understanding the OS is essential for genuine programmers, as software operates within the abstractions and constraints imposed by the system, and one inevitably encounters it when moving from high-level language-specific code down to low-level hardware instructions.
...
The 1960s marked the emergence of [multiprogramming]() and [time-sharing systems]() which allowed multiple jobs or users to share the CPU. This shift enabled interactive computing and drove projects such as MIT’s Compatible Time-Sharing System (CTSS) and Multics, that introduced key OS features such as [hierarchical file systems]() (HFS), memory protection, and user-level abstraction. These innovations laid the groundwork for [Unix](), developed in the early 1970s, emphasising modularity, portability, and multi-user capabilities. These principles continue to shape modern OS design. 

<!-- The spread of [minicomputers](), including [programmed data processors]() (PDPs), helped popularise OS beyond institutional settings. -->

The 1980s ushered in the personal computing era where the focuse of OS development transited into the [graphical user interfaces]() (GUI) from the traditional [command-line interfaces]() (CLI). As such, Microsoft introduced [MS-DOS]() in 1981, followed by [Windows]() in subsequent years, ultimately becoming the dominant OS in the consumer market. Around the same time, Apple’s [Macintosh OS]() (macOS) brought GUI to the mainstream. Meanwhile, [Linux](), inspired by Unix, emerged in the 1990s as a free, open-source OS, fueling innovation across servers, mobile devices, and embedded systems.
